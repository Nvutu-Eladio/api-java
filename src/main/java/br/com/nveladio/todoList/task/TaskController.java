package br.com.nveladio.todoList.task;
...
import br.com.nveladio.todoList.utils.Utils;
...
public class TaskController {
    ...
    public void updtate(@RequestBody TaskModel taskModel, HttpServletRequest request, @PathVariable UUID id) {
